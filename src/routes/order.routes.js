...
const { correctAmount: correctAmountValidator } = require('../validators/orderAmount.validator');
...
router.post('/:id/correct-amount', correctAmountValidator, validate, controller.correctAmount);
